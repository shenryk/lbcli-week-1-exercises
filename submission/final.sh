...
# WRITE YOUR SOLUTION BELOW:
LEGACY_ADDR= bitcoin-cli --rpcwallet=treasurewallet getnewaddress -addresstype legacy
check_cmd "Legacy address generation"

P2SH_ADDR=bitcoin-cli --rpcwallet=treasurewallet getnewaddress -addresstype p2sh-segwit
check_cmd "P2SH address generation"

SEGWIT_ADDR=bitcoin-cli --rpcwallet=treasurewallet getnewaddress -addresstype bech32
check_cmd "SegWit address generation"

TAPROOT_ADDR=bitcoin-cli --rpcwallet=treasurewallet getnewaddress -addresstype bech32m
...
# WRITE YOUR SOLUTION BELOW:
NEW_BALANCE= bitcoin-cli --rpcwallet=treasurewallet getbalance
...
# WRITE YOUR SOLUTION BELOW:
P2SH_VALID=bitcoin-cli --rpcwallet=treasurewallet validateaddress $P2SH_ADDR
...
# WRITE YOUR SOLUTION BELOW:
VERIFY_RESULT=bitcoin-cli --rpcwallet=treasurewallet verifymessage $LEGACY_ADDR "$SIGNATURE" "$SECRET_MESSAGE"
...
# WRITE YOUR SOLUTION BELOW:
NEW_TAPROOT_ADDR=bitcoin-cli --rpcwallet=treasurewallet getnewaddress -addresstype bech32m
...
# WRITE YOUR SOLUTION BELOW:
ADDR_INFO=bitcoin-cli --rpcwallet=treasurewallet getaddressinfo $NEW_TAPROOT_ADDR
check_cmd "Getting address info"

# STUDENT TASK: Extract the internal key (the x-only pubkey) from the descriptor
# WRITE YOUR SOLUTION BELOW:
INTERNAL_KEY=bitcoin-cli --rpcwallet=treasurewallet getdescriptorinfo "tr($NEW_TAPROOT_ADDR)"
...
SIMPLE_DESCRIPTOR=bitcoin-cli --rpcwallet=treasurewallet getdescriptorinfo "tr($INTERNAL_KEY)"
echo "Simple descriptor: $SIMPLE_DESCRIPTOR"

# STUDENT TASK: Get a proper descriptor with checksum
# WRITE YOUR SOLUTION BELOW:
TAPROOT_DESCRIPTOR=bitcoin-cli --rpcwallet=treasurewallet getdescriptorinfo "tr($INTERNAL_KEY)"
...
# WRITE YOUR SOLUTION BELOW:
DERIVED_ADDR_RAW=bitcoin-cli --rpcwallet=treasurewallet getaddressinfo $TAPROOT_DESCRIPTOR
